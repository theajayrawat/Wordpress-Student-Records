...
<body>
    <br />
    <form name="myForm" action="student_insert.php" method="post"  onsubmit="return validateForm()">
    ...
    if(isset($_POST["submit"])){
        ...
        $sql = "INSERT INTO student (name, number, course_id)
        VALUES ('$name', '$number', '$course')";
